...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
	public class GetBucketReplicationRequestMarshaller : IMarshaller<IRequest, GetBucketReplicationRequest>, IMarshaller<IRequest, AmazonWebServiceRequest>
	{
		...
		public IRequest Marshall(GetBucketReplicationRequest getBucketReplicationConfigurationRequest)
		{
			...
			DefaultRequest val = new DefaultRequest(getBucketReplicationConfigurationRequest, "AmazonS3");
			val.set_Suppress404Exceptions(true);
			val.set_HttpMethod("GET");
			val.set_ResourcePath("/" + S3Transforms.ToStringValue(getBucketReplicationConfigurationRequest.BucketName));
