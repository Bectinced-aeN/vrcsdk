		...
		private static int[] Square(int[] w, int[] x)
		{
			...
			for (int num2 = x.Length - 1; num2 > 0; num2--)
			{
				...
				for (int num5 = num2 - 1; num5 >= 0; num5--)
				{
					...
					num4 = (ulong)((long)num4 + (((long)(uint)w[--num] & 4294967295L) + ((uint)num6 << 1)));
					w[num] = (int)num4;
		...
		public BigInteger Remainder(BigInteger n)
		{
			...
			if (n.magnitude.Length == 1)
			{
				...
				if (num > 0)
				{
					...
					return (num2 != 0) ? new BigInteger(sign, new int[1]
					{
						num2
					}, checkMag: false) : Zero;
				}
		...
		public string ToString(int radix)
		{
			...
			case 16:
			{
				...
				case 10:
				{
					...
					{
						long num = 9223372036854775807L / radix;
						long num2 = radix;
						int num3 = 1;
						while (num2 <= num)
						{
