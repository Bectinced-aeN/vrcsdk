...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecT233R1Point : AbstractF2mPoint
	{
		...
		public override ECPoint Add(ECPoint b)
		{
			...
			return new SecT233R1Point(curve, eCFieldElement10, y, new ECFieldElement[1]
			{
				eCFieldElement12
			}, base.IsCompressed);
		}
		...
		public override ECPoint TwicePlus(ECPoint b)
		{
			...
			return new SecT233R1Point(curve, x3, y, new ECFieldElement[1]
			{
				eCFieldElement7
			}, base.IsCompressed);
		}
		...
		public override ECPoint Negate()
		{
			...
			ECFieldElement rawYCoord = base.RawYCoord;
			ECFieldElement eCFieldElement = base.RawZCoords[0];
			return new SecT233R1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1]
			{
				eCFieldElement
			}, base.IsCompressed);
		}
