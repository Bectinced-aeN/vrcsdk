...
namespace VRC.Core
{
	public static class API
	{
		...
		{
			if (EditorPrefs.GetBool("apiLoggingEnabled"))
			{
				Logger.AddDebugLevel(DebugLevel.API);
			}
			if (EditorPrefs.GetBool("allLoggingEnabled"))
			{
				Logger.AddDebugLevel(DebugLevel.All);
			}
		}
