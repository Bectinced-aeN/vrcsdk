...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecT163K1Point : AbstractF2mPoint
	{
		...
		public override ECPoint Add(ECPoint b)
		{
			...
			return new SecT163K1Point(curve, eCFieldElement10, y, new ECFieldElement[1]
			{
				eCFieldElement12
			}, base.IsCompressed);
		}
		...
		public override ECPoint Twice()
		{
			...
			ECFieldElement y = eCFieldElement5.Add(eCFieldElement2).Add(b2).Multiply(eCFieldElement5)
				.Add(eCFieldElement3);
			return new SecT163K1Point(curve, eCFieldElement3, y, new ECFieldElement[1]
			{
				eCFieldElement4
			}, base.IsCompressed);
		}
		...
		public override ECPoint TwicePlus(ECPoint b)
		{
			...
			return new SecT163K1Point(curve, x3, y, new ECFieldElement[1]
			{
				eCFieldElement7
			}, base.IsCompressed);
		}
		...
		public override ECPoint Negate()
		{
			...
			ECFieldElement rawYCoord = base.RawYCoord;
			ECFieldElement eCFieldElement = base.RawZCoords[0];
			return new SecT163K1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1]
			{
				eCFieldElement
			}, base.IsCompressed);
		}
