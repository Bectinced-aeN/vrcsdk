...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecT163Field
	{
		...
		protected static void ImplMultiply(ulong[] x, ulong[] y, ulong[] zz)
		{
			...
			num2 = (((num >> 55) ^ (num2 << 9)) & 0x7FFFFFFFFFFFFF);
			num &= 0x7FFFFFFFFFFFFF;
			ulong num4 = y[0];
			ulong num5 = y[1];
			ulong num6 = y[2];
			num6 = ((num5 >> 46) ^ (num6 << 18));
			num5 = (((num4 >> 55) ^ (num5 << 9)) & 0x7FFFFFFFFFFFFF);
			num4 &= 0x7FFFFFFFFFFFFF;
			...
			num20 ^= num19 >> 55;
			num19 &= 0x7FFFFFFFFFFFFF;
			num21 ^= num20 >> 55;
			num20 &= 0x7FFFFFFFFFFFFF;
