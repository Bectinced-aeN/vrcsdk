...
namespace Org.BouncyCastle.Crypto.Macs
{
	internal class Poly1305 : IMac
	{
		...
		public int DoFinal(byte[] output, int outOff)
		{
			...
			h3 = ((h3 & num7) | (num5 & num));
			h4 = ((h4 & num7) | (num6 & num));
			ulong num8 = (ulong)((long)(h0 | (h1 << 26)) + (long)k0);
			ulong num9 = (ulong)((long)((h1 >> 6) | (h2 << 20)) + (long)k1);
			ulong num10 = (ulong)((long)((h2 >> 12) | (h3 << 14)) + (long)k2);
			ulong num11 = (ulong)((long)((h3 >> 18) | (h4 << 8)) + (long)k3);
